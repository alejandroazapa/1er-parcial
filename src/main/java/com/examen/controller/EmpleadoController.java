...
public class EmpleadoController {
	...
	@GetMapping("/{id}")
	public ResponseEntity<Empleado> getLibroId(@PathVariable("id") Long id){
		try {
	...
	@DeleteMapping("/{id}")
	public ResponseEntity<Empleado> delLibro(@PathVariable("id") Long id){
		try {
	...
	@PutMapping("/{id}")
	public ResponseEntity<?> updateLibro(@PathVariable("id") Long id, @Valid @RequestBody Empleado cat){
